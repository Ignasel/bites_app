...
import static com.dinner.dinner.R.layout.activity_register;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public static final String DB_INSERT = "http://ignas.epizy.com/mobile/db.php";
    ...
    private void insertToDB (Users users){
        class Register extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... strings) {
                ...
                users.put("password", strings[1]);
                users.put("email", strings[2]);
