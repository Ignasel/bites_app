    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                conn.setRequestProperty("Cookie", "__test=b6e3daa78c8acc99a46c9e1123cda534; expires=2038 m. sausio 1 d., penktadienis 01:55:55; path=/");
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        Dinner dinner = new Dinner(
                                json_data.getInt("id"),
                                json_data.getString("pletimas"),
                                json_data.getString("motinele"),
                                json_data.getString("seimosNr"),
                                json_data.getString("medus"),
                                json_data.getString("komentaras")
                        );
                        Log.e("dinner2",dinner.getPletimasType()+ " "+ dinner.getKomentaras());
                        data.add(dinner);
                    }
